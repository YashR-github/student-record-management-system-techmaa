...
export default function StaffProfile() {
    ...
    async function fetchProfile() {
        ...
        setError(null)
        try {
            const res = await authService.getProfile('staff')
    ...
    async function handleSave(e) {
        ...
        try {
            const payload = {
                ...
                // Include password only if updated via modal
                ...(pendingPassword && { password: pendingPassword })
            }

            await authService.updateProfile('staff', payload)
    ...
    async function confirmDelete() {
        ...
        try {
            await authService.deleteProfile('staff')
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-[#1e293b] px-8 py-6 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-slate-300 text-sm mt-1">Staff Account</p>
                    </div>
                </div>
                ...
                <div className="p-8">
                    ...
                    {data ? (
                        <form onSubmit={handleSave} className="space-y-6">
                            ...
                            {/* Section 1: Personal (Name, Email, Phone, Gender, Age, Address) */}
                            ...
                            {/* Section 2: Professional (Staff ID, Dept, Role, Course ID, Course Title) */}
                            <h3 className="text-lg font-medium text-gray-800 border-b pb-2 pt-4">Professional Information</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none"
                                        placeholder="Assigned Course ID"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled
                                        className="w-full rounded-md border border-gray-300 px-3 py-2 bg-gray-100 text-gray-500 cursor-not-allowed"
                                        placeholder="Course name auto-fetched"
                                    />
                                </div>
                            </div>
