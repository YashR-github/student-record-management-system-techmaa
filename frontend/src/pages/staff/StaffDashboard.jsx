    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="bg-[#1e293b] px-8 py-6 flex items-center justify-between">
                ...
                <div>
                    <Link to="/staff/profile" className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 active:bg-blue-800 active:scale-95 transition-all duration-200 mr-3">Profile</Link>
                    <button
