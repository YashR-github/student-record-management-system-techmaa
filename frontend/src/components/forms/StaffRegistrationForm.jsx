...
export default function StaffRegistrationForm({ isAdminMode = false, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Handle optionals
        const optionals = ['gender', 'department', 'address', 'age']
        optionals.forEach(k => {
    ...
    return (
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                    {loading ? 'Processing...' : (isAdminMode ? 'Register Candidate' : 'Register Staff')}
                </button>
            </form>
        </div>
    )
...
/* Helpers (Duplicated to be self-contained components) */
